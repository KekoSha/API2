...
namespace NetCore2_With_Auth.Helpers
{
    public class UserFile
    {
        ...
        //-------------------------------------------------------------------------------------------------------
        internal static async Task<string> UploadeNewImageAsync(string oldFileNameToBeDeleted, IFormFile uploadedFile, string WebRootPath, string folder, int v1, int v2)
        {
        ...
        //-----------------------------------------------------------------------------------------
        public static async Task<string> UploadeNewFileAsync(string oldFileNameToBeDeleted, IFormFile uploadedFile, string WebRootPath, string folder, int v1, int v2)
        {
            if ((uploadedFile != null) && (uploadedFile.Length > 0))
            {
                if (!string.IsNullOrEmpty(oldFileNameToBeDeleted) && !string.IsNullOrWhiteSpace(oldFileNameToBeDeleted))
